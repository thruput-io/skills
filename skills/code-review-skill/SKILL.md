...
3.  **Perform and Submit Code Review**: When executing the code review, you must follow the guidelines and instructions outlined in the handbook: `references/CODE_REVIEW.md`. Additionally, analyze the diffs for:
